            ...
            <h1 class="logo"><a href="index.html">Booked</a></h1>
                 ...
                 <nav id="navbar" class="navbar">
                     <ul>
                         ...
                         <li><a class="nav-link scrollto" href="/addbookform">Add books</a></li>
        ...
        <header class="bg-dark py-5"  >
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Welcome Vendors</h1>
                    <p class="lead fw-normal text-white-50 mb-0">Join our thriving community and showcase your books to a wide audience</p>
                </div>
            </div>
        </header>
